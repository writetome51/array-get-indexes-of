...
export const getIndexesByIdenticalMatching = (value, array, howMany) => {
	for (
...
export const getIndexesByIdenticalMatching_fromRight = (value, array, howMany) => {
...
export const getIndexesByArrayMatching = (arrToSearchFor, arrToSearchIn, howMany) => {
	for (
...
export const getIndexesByArrayMatching_fromRight = (arrToSearchFor, arrToSearchIn, howMany) => {
	howMany = Math.abs(howMany);
