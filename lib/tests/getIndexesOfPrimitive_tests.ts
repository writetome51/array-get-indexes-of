import { getIndexesOfPrimitive } from '../privy/getIndexesOfPrimitive';
...
// Test 1
let indexes = getIndexesOfPrimitive(1, arr);
...
indexes = getIndexesOfPrimitive('abc', arr);
...
indexes = getIndexesOfPrimitive(false, arr);
...
indexes = getIndexesOfPrimitive(2, arr);
...
indexes = getIndexesOfPrimitive(100, arr);
